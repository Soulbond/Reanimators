package com.unco.reanimators.gui.reanimators.theme.staticui;

import com.unco.reanimators.gui.reanimators.ReanimatorsGUI;
import com.unco.reanimators.gui.reanimators.component.TabGUI;
...
public class TabGuiUI extends AbstractComponentUI<TabGUI> {
    ...
    public void renderComponent(TabGUI component, FontRenderer fontRenderer) {
        ...
        ReanimatorsGUI.primaryColour.setGLColour();
