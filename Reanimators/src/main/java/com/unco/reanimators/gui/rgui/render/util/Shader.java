package com.unco.reanimators.gui.rgui.render.util;

import java.util.HashMap;
import java.util.Map;

import static com.unco.reanimators.gui.rgui.render.util.ShaderHelper.createProgram;
import static com.unco.reanimators.gui.rgui.render.util.ShaderHelper.loadShader;
