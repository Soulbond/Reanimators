package com.unco.reanimators.setting.config;
...
import com.unco.reanimators.setting.converter.Convertable;
...
public class Configuration {
    ...
    public static void loadConfiguration(InputStream stream) {
        try {
            ...
            Reanimators.log.error("Reanimators Config malformed: resetting.");
