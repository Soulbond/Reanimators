...
import com.unco.reanimators.util.ColourUtils;
...
public class StorageESP extends Module
{
    ...
    public StorageESP() {
        ...
        this.dispenser = this.register(Settings.b("Dispenser", false));
        this.shulker = this.register(Settings.b("Shulker", true));
        this.echest = this.register(Settings.b("Ender Chest", true));
        this.furnace = this.register(Settings.b("Furnace", false));
        this.hopper = this.register(Settings.b("Hopper", false));
        this.cart = this.register(Settings.b("Minecart", false));
        this.frame = this.register(Settings.b("Item Frame", false));
    }
    ...
    public void onWorldRender(final RenderEvent event) {
        ...
        ReanimatorsTessellator.prepare(7);
        for (final Triplet<BlockPos, Integer, Integer> pair : a) {
            ReanimatorsTessellator.drawBox(pair.getFirst(), this.changeAlpha(pair.getSecond(), 100), pair.getThird());
        }
