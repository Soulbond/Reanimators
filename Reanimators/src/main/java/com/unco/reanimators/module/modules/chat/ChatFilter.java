 ...
 */
@Module.Info(name = "ChatFilter", category = Module.Category.CHAT)
    ...
    private boolean detectSpam(String message) {
        ...
        if (greenText.getValue() && findPatterns(FilterPatterns.GREEN_TEXT, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Green Text: " + message);
            }
            return true;
        }
        ...
        if (discordLinks.getValue() && findPatterns(FilterPatterns.DISCORD, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Discord Link: " + message);
            }
            return true;
        }
        ...
        if (webLinks.getValue() && findPatterns(FilterPatterns.WEB_LINK, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Web Link: " + message);
            }
            return true;
        }
        ...
        if (ips.getValue() && findPatterns(FilterPatterns.IP_ADDR, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] IP Address: " + message);
            }
            return true;
        }
        ...
        if (ipsAgr.getValue() && findPatterns(FilterPatterns.IP_ADDR_AGR, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] IP Aggressive: " + message);
            }
            return true;
        }
        ...
        if (tradeChat.getValue() && findPatterns(FilterPatterns.TRADE_CHAT, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Trade Chat: " + message);
            }
            return true;
        }
        ...
        if (numberSuffix.getValue() && findPatterns(FilterPatterns.NUMBER_SUFFIX, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Number Suffix: " + message);
            }
            return true;
        }
        ...
        if (announcers.getValue() && findPatterns(FilterPatterns.ANNOUNCER, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Announcer: " + message);
            }
            return true;
        }
        ...
        if (spammers.getValue() && findPatterns(FilterPatterns.SPAMMER, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Spammers: " + message);
            }
            return true;
        }
        ...
        if (insulters.getValue() && findPatterns(FilterPatterns.INSULTER, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Insulter: " + message);
            }
            return true;
        }
        ...
        if (greeters.getValue() && findPatterns(FilterPatterns.GREETER, message)) {
            if (showBlocked.getValue()) {
                Command.sendChatMessage("[ChatFilter] Greeter: " + message);
            }
            return true;
        }
        ...
        if (duplicates.getValue()) {
            ...
            if (isDuplicate) {
                if (showBlocked.getValue()) {
                    Command.sendChatMessage("[ChatFilter] Duplicate: " + message);
                }
                return true;
            }
        }
