...
public class Module {
    ...
    public void enable() {
        ...
        onEnable();
        if (!alwaysListening)
            Reanimators.EVENT_BUS.subscribe(this);
    }
    ...
    public void disable() {
        ...
        onDisable();
        if (!alwaysListening)
            Reanimators.EVENT_BUS.unsubscribe(this);
    }
    ...
    protected final void setAlwaysListening(boolean alwaysListening) {
        ...
        if (alwaysListening) Reanimators.EVENT_BUS.subscribe(this);
        if (!alwaysListening && isDisabled()) Reanimators.EVENT_BUS.unsubscribe(this);
    }
    public void destroy(){};
