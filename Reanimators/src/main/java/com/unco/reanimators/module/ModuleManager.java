package com.unco.reanimators.module;

import com.unco.reanimators.Reanimators;
import com.unco.reanimators.event.events.RenderEvent;
import com.unco.reanimators.module.modules.ClickGUI;
import com.unco.reanimators.util.ClassFinder;
...
public class ModuleManager {
    ...
    public static void initialize() {
        ...
        Reanimators.log.info("Modules initialised");
    ...
    public static void onWorldRender(RenderWorldLastEvent event) {
        Minecraft.getMinecraft().profiler.startSection("reanimators");
        ...
        RenderEvent e = new RenderEvent(ReanimatorsTessellator.INSTANCE, renderPos);
        e.resetTranslation();
