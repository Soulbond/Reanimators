...
@Module.Info(name = "KamiElytra", description = "Allows infinite elytra flying", category = Module.Category.MOVEMENT)
public class KamiElytra extends Module {
    ...
    public void onUpdate() {
        ...
        if (defaultSetting.getValue()) {
            ...
            Command.sendChatMessage("[KamiElytra] Set to defaults!");
        }
