...
import com.unco.reanimators.util.BlockInteractionHelper;
...
import static com.unco.reanimators.util.BlockInteractionHelper.canBeClicked;
import static com.unco.reanimators.util.BlockInteractionHelper.faceVectorPacketInstant;

@Module.Info(name = "FastAutoTrap", category = Module.Category.COMBAT)
