...
import com.unco.reanimators.module.modules.misc.AutoTool;
...
public class KillAura extends Module {
    ...
    private Setting<Boolean> attackMobs = register(Settings.b("Mobs", true));
    private Setting<Boolean> attackAnimals = register(Settings.b("Animals", true));
    private Setting<Double> hitRange = register(Settings.d("Hit Range", 6d));
