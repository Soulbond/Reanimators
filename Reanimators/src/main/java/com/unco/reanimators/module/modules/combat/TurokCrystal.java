...
// Rina.
@Module.Info(name = "TurokCrystal", category = Module.Category.COMBAT)
public class TurokCrystal extends Module {
    ...
    public void onWorldRender(final RenderEvent event) {
        if (render != null) {
            ...
            ReanimatorsTessellator.drawBox(render, cor_red.getValue(), cor_green.getValue(), cor_blue.getValue(), cor_alfa.getValue(), 63);
