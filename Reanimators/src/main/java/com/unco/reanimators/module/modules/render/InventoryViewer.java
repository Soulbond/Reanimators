package com.unco.reanimators.module.modules.gui;
 ...
 */
@Module.Info(name = "InventoryViewer", category = Module.Category.RENDER, description = "View your inventory on screen")
public class InventoryViewer extends Module {
    ...
    ReanimatorsGUI reanimatorsGUI = Reanimators.getInstance().getGuiManager();
    private int invPos(int i) {
        reanimatorsGUI = Reanimators.getInstance().getGuiManager();
        if (reanimatorsGUI != null) {
            List<Frame> frames = ContainerHelper.getAllChildren(Frame.class, reanimatorsGUI);
    ...
    private ResourceLocation getBox() {
        if (viewMode.getValue().equals(ViewMode.CLEAR)) {
            ...
            return new ResourceLocation("textures/gui/container/iconback.png");
        }
        else if (viewMode.getValue().equals(ViewMode.SOLID)) {
            return new ResourceLocation("textures/gui/container/solid.png");
        }
        else if (viewMode.getValue().equals(ViewMode.SOLIDCLEAR)) {
            return new ResourceLocation("textures/gui/container/solidclear.png");
        }
        else if (viewMode.getValue().equals(ViewMode.ICON)) {
            return new ResourceLocation("textures/gui/container/icon.png");
        }
        else if (viewMode.getValue().equals(ViewMode.ICONLARGE)) {
            return new ResourceLocation("textures/gui/container/iconlarge.png");
        }
        else if (viewMode.getValue().equals(ViewMode.ICONLARGEBG)) {
            return new ResourceLocation("textures/gui/container/iconlargebg.png");
        }
        else {
