...
import com.unco.reanimators.util.HueCycler;
import com.unco.reanimators.util.ReanimatorsTessellator;
import com.unco.reanimators.util.TrajectoryCalculator;
...
/**
 * Created by 086 on 28/12/2017. baldhack paste
 */
        ...
        try {
            mc.world.loadedEntityList.stream()
                ...
                if (hit != null){
                    ...
                    ReanimatorsTessellator.drawBox(hit, 0x33ffffff, GeometryMasks.FACEMAP.get(flightPath.getCollidingTarget().sideHit));
