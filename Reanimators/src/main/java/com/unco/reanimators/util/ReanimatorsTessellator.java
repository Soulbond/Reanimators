...
public class ReanimatorsTessellator extends Tessellator {

    public static ReanimatorsTessellator INSTANCE = new ReanimatorsTessellator();

    public ReanimatorsTessellator() {
        super(0x200000);
    }
